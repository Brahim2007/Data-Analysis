  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 1440, margin: "0 auto", padding: "20px 16px" }}>
        ...
        <div style={{
          background: dark
            ? "linear-gradient(135deg,#1A0A10,#2A0A18)"
            : "linear-gradient(135deg,#FE2C55,#FF6B6B)",
          borderRadius: 16, padding: "20px 25px", marginBottom: 22,
          border: `2px solid ${dark ? "#FE2C5540" : "#FE2C5580"}`,
          boxShadow: `0 8px 32px ${dark ? "rgba(254,44,85,0.2)" : "rgba(254,44,85,0.25)"}`,
          textAlign: "center", direction: "rtl",
        }}>
          <h1 style={{
            fontSize: 26, fontWeight: 800,
            color: dark ? "#FFD0D8" : "#FFFFFF",
            fontFamily: "'IBM Plex Sans Arabic',sans-serif", marginBottom: 8,
            textShadow: "0 2px 4px rgba(0,0,0,0.2)",
          }}>📊 تقرير تحليل الحساب المتقدم — گفتمان فرهنگی (@dialog.fa)</h1>
          <p style={{
            fontSize: 15, fontFamily: "'IBM Plex Sans Arabic',sans-serif", fontWeight: 500,
            color: dark ? "#FFB3C0" : "#FFF0F2", marginBottom: 12,
          }}>لوحة تحليل بيانات TikTok متكاملة مع توقعات النمو والتوصيات الاستراتيجية</p>
          <div style={{
            background: dark ? "rgba(0,0,0,0.3)" : "rgba(255,255,255,0.15)",
            borderRadius: 10, padding: "10px 15px", display: "inline-block",
            border: `1px solid ${dark ? "rgba(254,44,85,0.3)" : "rgba(255,255,255,0.3)"}`,
          }}>
            <p style={{
              fontSize: 12, margin: 0,
              color: dark ? "#FFB3C0" : "#FFF0F2",
              fontFamily: "'IBM Plex Sans Arabic',sans-serif",
            }}>
